...
#define FontSetPrivate xfont2_font_set_private
#endif
...
#define ResetFontPrivateIndex(...) /* remove the function call */
#endif
...
typedef xfont2_pattern_cache_ptr pattern_cache_ptr;
#else
typedef FontPatternCachePtr pattern_cache_ptr;
#endif
